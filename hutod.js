...
const nomorOwner = [`6283839990008`]
...
const newReply = (teks) => {
client.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `𝐃𝐄𝐋𝐋𝐎𝐍 𝐍𝐎𝐈𝐑-TAMVAN`,"body": `👋🏻 Hai kak ${pushname}`, "previewType": "PHOTO","thumbnail": thumb,"sourceUrl": `https://youtube.com/@Adityastore22`}}}, { quoted: msg})}
...
body: "HuTod",
thumbnail: thumb,
sourceUrl: "https://chat.whatsapp.com/Hi6VLWM4ZbmAJCU583q12l",
mediaType: 1,
...
break
case "listpanel": {
newReply("乂 *𝗟𝗜𝗦𝗧 𝗛𝗔𝗥𝗚𝗔 𝗣𝗔𝗡𝗘𝗟 PROMO* 乂\n⚡ RAM 1 GB CPU 30% = 5K\n⚡ RAM 3 GB CPU 100% = 10K \n⚡ RAM 8GB COU 190% = 20K\n ⚡ ADMIN PANEL = 25K\n⚡ RAM UNLIMITED & CPU = 25K\n\n*〽️LOGIN PANEL*\n⚡ https://server.tokocpannelmurah.xyz\n⚡ http://dayy.storepannel.xyz/\n\n*⚡ WEBSITE COIN*\n💸https://tokocpannelmurah.xyz/register\n\n🔰「 𝙱𝚄𝚈 𝙿𝙰𝙽𝙴𝙻 𝙲𝙷𝙰𝚃 」\nhttps://wa.me/6283839990008")
}
break
case "listsewa": {
newReply("乂 *SEWA BOT* 乂\n🛑 *1 BULAN = 20K*\n\n🔰「 𝙲𝙷𝙰𝚃 」\nhttps://wa.me/6281245275612")
}
break
case 'owner': 
case 'creator': {
